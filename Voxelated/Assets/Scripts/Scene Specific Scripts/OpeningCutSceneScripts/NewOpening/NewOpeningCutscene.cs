...
public class NewOpeningCutscene : MonoBehaviour {
    ...
    public void RunThrough ()
    {
        switch (step)
        {
            ...
            case 1:
                chat.SetActive(true);
                this.GetComponent<TextTyper>().RecieveText("Once I was living a normal life", "OpeningCutscene_001");
                break;
            case 2:
                this.GetComponent<TextTyper>().RecieveText("Until one day my friend" + " " + fName + " " + "took me to the stonehenge", "OpeningCutscene_002");
                show[2].SetActive(true);
                break;
            case 3:
                this.GetComponent<TextTyper>().RecieveText("A rift appeared and" + " " + fName + " " + "was sucked in", "OpeningCutscene_003");
            ...
            case 6:
                ...
                break;
            case 7:
                this.GetComponent<TextTyper>().RecieveText("A wizard found me and took care of my wounds", "OpeningCutscene_004");
                break;
            case 8:
                this.GetComponent<TextTyper>().RecieveText("He explained that the rift was opened by an ancient beast and would open again in 7 years", "OpeningCutscene_005");
                break;
            case 9:
                this.GetComponent<TextTyper>().RecieveText("He trained me and gave me the gear he found on his own adventure in the rift", "OpeningCutscene_006");
                break;
            case 10:
                this.GetComponent<TextTyper>().RecieveText("I have to rescue" + " " + fName, "OpeningCutscene_007");
                break;
            case 11:
        ...
        //OLD SYSTEM SWITCH INACT TO STEP TO TURN ON AGAIN
        //int inact =  -1;
        //switch (inact)
        //{
